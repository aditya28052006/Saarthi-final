...
public class OpenMeteoProvider implements WeatherProvider {
    ...
    String buildUrl(List<SamplePoint> points) {
        ...
        String lon = points.stream()
                ...
                .collect(Collectors.joining(","));
        String hourly = "precipitation,temperature_2m,relative_humidity_2m,precipitation_probability,wind_speed_10m";
        String daily = "precipitation_sum,precipitation_probability_max,temperature_2m_max,temperature_2m_min";
    ...
    private LocationDailyForecast parseLocation(JsonNode loc) throws WeatherProviderException {
        ...
        List<DailyPointValues> days = parseDaily(daily);
        if (days.isEmpty()) {
